...
impl Uart {
    pub fn init() {
        ...
        Mmio::write(mmio::UART0_IBRD,  1);
        Mmio::write(mmio::UART0_FBRD, 43);
    ...
    pub fn putc(ch: u8) {
        ...
        Mmio::write(mmio::UART0_DR, ch as u32);
    }
